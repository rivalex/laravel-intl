...
if (! function_exists('country')) {
     ...
     * @return \Rivalex\LaravelIntl\Country|string
     */
...
if (! function_exists('currency')) {
     ...
     *
     * @return \Rivalex\LaravelIntl\Currency|string
     */
    function currency()
    {
...
if (! function_exists('language')) {
     ...
     * @return \Rivalex\LaravelIntl\Language|string
     */
...
if (! function_exists('number')) {
     ...
     * @param array $options
     * @return \Rivalex\LaravelIntl\Number|string
     */
